...
export default function SafetyFeatures() {
  ...
  return (
    <div className="p-4 md:p-6">
        ...
        <div className="w-full md:w-1/2 p-4 rounded-lg shadow-md">
          ...
          <ul className="list-disc pl-5">
            {safetyFeaturesData.map((featureItem) => (
              <li
                key={featureItem._id}
                className="flex flex-col md:flex-row justify-between items-center px-5 py-2 mb-4 rounded-md bg-slate-50"
              >
      ...
      >
        <p>
          Are you sure you want to delete this safety feature? This action
          cannot be undone.
        </p>
      </CustomModal>
