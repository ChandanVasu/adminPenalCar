...
export default function Make() {
  ...
  return (
    <div className="p-0 sm:p-6">
        ...
        <div className="w-full sm:w-1/2 p-4 rounded-lg shadow-md">
          ...
          <ul className="list-disc pl-0 md:pl-5">
            {makeData.map((makeItem) => (
              <li
                key={makeItem._id}
                className="flex flex-wrap justify-between items-center px-5 py-2 mb-4 rounded-md bg-slate-50"
              >
                <img
                  src={makeItem.image}
                  alt={makeItem.make}
      ...
      >
        <p>
          Are you sure you want to delete this make? This action cannot be
          undone.
        </p>
      </CustomModal>
    </div>
